...
public class FragmentReturns extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_returns_records, container, false);
    }
    ...
    private LinkedList<ProductModel> getProducts() {
        ...
        String p = getArguments().getString("Returns");
        Gson gson = new Gson();
